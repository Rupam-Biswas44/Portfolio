...
const projectsMeta = [
    ...
    },
    {
        color: "#00ffff",
        id: "PROT-AGRI-03",
        link: "https://github.com/Rupam-Biswas44/Plant-Disease-AI.git",
    ...
    },
    {
        color: "#00ffff",
        id: "PROT-AERO-08",
        link: "https://github.com/Rupam-Biswas44/AeroRescueAI.git",
        image: "/proj_aerorescue.png"
    },
    {
        color: "#9333ea",
        id: "PROT-CERE-09",
        link: "https://github.com/Rupam-Biswas44/cerebrum.git",
        image: "/proj_cerebrum.png"
    },
    {
        color: "#00ffff",
        id: "PROT-NOVA-10",
        link: "https://github.com/Rupam-Biswas44/nova-os.git",
        image: "/proj_nova_os.png"
    },
];

function ProjectCard({ project, index, viewSourceText }: { project: any; index: number; viewSourceText: string }) {
...
export default function ProjectsSection() {
    const { t } = useLanguage();
    const tp = t.projects;
    const projects = tp.items.map((item, i) => ({ ...item, ...projectsMeta[i] }));
        ...
        >
            ...
            >
                ...
                <h2 style={{ fontSize: "clamp(2.5rem, 8vw, 5rem)", fontWeight: 900, color: "#fff", margin: "1rem 0", letterSpacing: "-0.05em" }}>
                    {tp.heading}<span style={{ color: "#00ffff" }}>{tp.headingAccent}</span>
                </h2>
            </motion.div>
            ...
            >
                {projects.map((p, i) => (
                    <ProjectCard key={p.id} project={p} index={i} viewSourceText={tp.viewSource} />
                ))}
            </div>
        </section>
    );
